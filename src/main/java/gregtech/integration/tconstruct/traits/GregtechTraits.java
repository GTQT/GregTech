...
public final class GregtechTraits {
    ...
    /** Consumes GT electric energy (GTEU) instead of durability. Cost: 1 modifier slot. */
    public static final ModifierGTElectric MODIFIER_GT_ELECTRIC = new ModifierGTElectric();

    /** All GT modifiers that carry additional capability providers. */
    public static final List<Modifier> MODIFIERS = Collections.singletonList(
