...
public class GhostMouldSlotWidget extends Widget<GhostMouldSlotWidget> implements Interactable,
    ...
    private GhostMouldSyncHandler syncHandler;

    public GhostMouldSlotWidget() {
    ...
    public boolean isValidSyncHandler(SyncHandler syncHandler) {
        this.syncHandler = castIfTypeElseNull(syncHandler, GhostMouldSyncHandler.class);
        return this.syncHandler != null;
    }

    public GhostMouldSlotWidget slot(IItemHandlerModifiable handlerModifiable, int index) {
        this.syncHandler = new GhostMouldSyncHandler(handlerModifiable, index);
                        ...
                        .child(new Grid()
                                ...
                                .mapTo(9, MetaItems.SHAPE_MOLDS.length, value -> new ButtonWidget<>()
                                        ...
                                        .onMousePressed(mouseButton -> {
                                            ...
                                            circuitPreview.setItem(MetaItems.SHAPE_MOLDS[value].getStackForm());
    ...
    private static class GhostMouldSyncHandler extends SyncHandler {
