...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        Salt = Material.builder(312, gregtechId("salt"))
                .gem(1).ore(2, 1)
                .fluid(FluidStorageKeys.LIQUID,
                        new FluidBuilder().temperature(1074).translation("gregtech.fluid.molten"))
        ...
        CupricOxide = Material.builder(371, gregtechId("cupric_oxide"))
                .dust(1)
                .color(0x0F0F0F)
        ...
        Ferrosilite = Material.builder(375, gregtechId("ferrosilite"))
                .dust(1)
                .color(0x97632A)
        ...
        Ammonia = Material.builder(408, gregtechId("ammonia"))
                ...
                .liquid(new FluidBuilder()
                        .block()
                        .attribute(FluidAttributes.BASE)
                        .temperature(240)
                        .color(0xB5E8FF)
                        .name("liquid_ammonia")
                        .translation("gregtech.fluid.liquid_generic"))
        ...
        HighGradeSolderingAlloy = Material.builder(453, gregtechId("high_grade_soldering_alloy"))
                .ingot(3)
                .liquid(new FluidBuilder().temperature(544))
