...
public class UnknownCompositionMaterials {
    ...
    public static void register() {
        ...
        LithiumBisoxalatoborate = Material.builder(1721, gregtechId("lithium_bisoxalatoborate"))
                .fluid()
                .color(0xF0F0E8)
                .build();
        ...
        LithiumBistriflimide = Material.builder(1722, gregtechId("lithium_bistriflimide"))
                .fluid()
                .color(0xE8F0F8)
                .build();
        ...
        ChargedZincManganeseElectrolyte = Material.builder(1723, gregtechId("charged_zinc_manganese_electrolyte"))
                .fluid()
                .color(0x8E8E48)
                .build();
        ...
        ChargedLithiumManganeseElectrolyte = Material.builder(1724, gregtechId("charged_lithium_manganese_electrolyte"))
                .fluid()
                .color(0x4E6570)
                .build();
        ...
        ChargedNickelCadmiumElectrolyte = Material.builder(1725, gregtechId("charged_nickel_cadmium_electrolyte"))
                .fluid()
                .color(0x4A7C6A)
                .build();
        ...
        ChargedLeadAcidElectrolyte = Material.builder(1726, gregtechId("charged_lead_acid_electrolyte"))
                .fluid()
                .color(0xBBB060)
                .build();
        ...
        ChargedVanadiumElectrolyte = Material.builder(1727, gregtechId("charged_vanadium_electrolyte"))
                .fluid()
                .color(0x7070DD)
                .build();
        ...
        // bright golden glow indicating stored electrochemical potential
        ChargedLithiumBisoxalatoborate = Material.builder(1728, gregtechId("charged_lithium_bisoxalatoborate"))
                .fluid()
                .color(0xF8E880)
                .build();
        ...
        ChargedLithiumBistriflimide = Material.builder(1729, gregtechId("charged_lithium_bistriflimide"))
                .fluid()
                .color(0xB8D8F8)
                .build();
        ...
        ChargedLithiumHexafluorophosphate = Material.builder(1730, gregtechId("charged_lithium_hexafluorophosphate"))
                .fluid()
                .color(0x80B0F0)
                .build();

        HoneycombExtract = Material.builder(1731, gregtechId("honeycomb_extract"))
                .fluid()
                .color(0xE679C1)
                .build();
        PremiumHoneycombExtract = Material.builder(1732, gregtechId("premium_honeycomb_extract"))
                .fluid()
                .color(0xF15FA2)
                .build();
        PremiumGradeHoneycombExtract = Material.builder(1733, gregtechId("premium_grade_honeycomb_extract"))
                .fluid()
                .color(0xE63770)
                .build();
    }
