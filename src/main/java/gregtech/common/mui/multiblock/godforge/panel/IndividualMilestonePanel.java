...
import static gregtech.common.metatileentities.multi.electric.godforge.util.ForgeOfGodsData.DEFAULT_FORMATTER;
import static gregtech.common.metatileentities.multi.electric.godforge.util.ForgeOfGodsData.FUEL_MILESTONE_T7_CONSTANT;
import static gregtech.common.metatileentities.multi.electric.godforge.util.ForgeOfGodsData.POWER_MILESTONE_T7_CONSTANT;
import static gregtech.common.metatileentities.multi.electric.godforge.util.ForgeOfGodsData.RECIPE_MILESTONE_T7_CONSTANT;
...
public class IndividualMilestonePanel {
    ...
    private static String getTotalProgress(Milestones milestone, Formatters formatter, SyncHypervisor hypervisor) {
        ...
        return TextFormatting.WHITE + translateToLocal("gt.blockmachines.multimachine.FOG.totalprogress")
            + ": "
            + TextFormatting.GRAY
    ...
    private static String getLevel(Milestones milestone, boolean inversion, SyncHypervisor hypervisor) {
        ...
        return TextFormatting.WHITE + translateToLocal("gt.blockmachines.multimachine.FOG.milestoneprogress")
            + ": "
            + TextFormatting.GRAY
            + level;
    }
    ...
    private static String getLevelProgress(Milestones milestone, Formatters formatter, boolean inversion,
        ...
        if (level >= 7 && !inversion) {
            return TextFormatting.WHITE + translateToLocal("gt.blockmachines.multimachine.FOG.milestonecomplete")
                + (formatter != DEFAULT_FORMATTER ? TextFormatting.DARK_RED + "?" : "");
        }
        ...
        return TextFormatting.WHITE + translateToLocal("gt.blockmachines.multimachine.FOG.progress")
            + ": "
            + TextFormatting.GRAY
    ...
    public static String getShardsGained(Milestones milestone, Formatters formatter, boolean inversion,
        ...
        return TextFormatting.WHITE + translateToLocal("gt.blockmachines.multimachine.FOG.shardgain")
            + ": "
            + TextFormatting.GRAY
