...
public abstract class MTEBaseModuleGui<T extends MTEBaseModule> extends GodforgeBaseGui<T> {
    ...
    public MTEBaseModuleGui(T multiblock) {
        super(multiblock, new SyncHypervisor(Modules.ANY, Panels.MAIN));
        ...
        return ((ButtonWidget<?>) super.createVoidExcessButton(syncManager)).size(16)
            ...
            .overlay(new DynamicDrawable(() -> {
                switch (multiblock.getVoidingMode()) {
                    case 0: return GTGuiTextures.TT_OVERLAY_BUTTON_VOIDING_OFF;
                    case 1: return GTGuiTextures.TT_OVERLAY_BUTTON_VOIDING_ITEMS;
                    case 2: return GTGuiTextures.TT_OVERLAY_BUTTON_VOIDING_FLUIDS;
                    case 3: return GTGuiTextures.TT_OVERLAY_BUTTON_VOIDING_BOTH;
                    default: return GTGuiTextures.TT_OVERLAY_BUTTON_VOIDING_OFF;
                }
            }))
            .tooltipShowUpTimer(TOOLTIP_DELAY)
            .clickSound(ForgeOfGodsGuiUtil.getButtonSound());
