        ...
        return new ButtonWidget<>().size(16)
            ...
            .overlay(new DynamicDrawable(() -> {
                if (magmatterMode.getBoolValue()) {
                    return new ItemDrawable(OreDictUnifier.get(OrePrefix.dust, Materials.NaquadahAlloy, 1));
                }
                return new ItemDrawable(OreDictUnifier.get(OrePrefix.dust, Materials.Neutronium, 1));
            }))
            .onMousePressed(d -> {
            ...
            .tooltipDynamic(t -> {
                ...
                if (!magmatterCapable.getBoolValue()) {
                    t.addLine(TextFormatting.GRAY + translateToLocal("fog.button.magmattermode.tooltip.03"));
                }
            })
