...
public class MTEForgeOfGodsGui extends GodforgeBaseGui<MetaTileEntityForgeOfGods> {

    private final ForgeOfGodsData data;

    public MTEForgeOfGodsGui(MetaTileEntityForgeOfGods multiblock) {
        super(multiblock, new SyncHypervisor(Panels.MAIN));
    ...
    private IWidget createBatteryConfigPanelButton() {
        ...
        return new ButtonWidget<>().size(16)
            ...
            .onMousePressed(d -> {
                ...
                } else if (d == 1 && data.isUpgradeActive(gregtech.common.metatileentities.multi.electric.godforge.upgrade.ForgeOfGodsUpgrade.REC)) {
            ...
            .tooltip(t -> {
                ...
                t.addLine(TextFormatting.GRAY + translateToLocal("fog.button.battery.tooltip.02"));
            })
            .tooltipShowUpTimer(TOOLTIP_DELAY);
    }
    ...
    private IWidget createShardEjectionButton() {
        ...
        return new ButtonWidget<>().size(16)
            .setEnabledIf($ -> data.isUpgradeActive(gregtech.common.metatileentities.multi.electric.godforge.upgrade.ForgeOfGodsUpgrade.END))
            .overlay(new DynamicDrawable(() -> {
