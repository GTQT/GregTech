...
public class MetaTileEntityCreativeEnergy extends MetaTileEntity implements ILaserContainer, IControllable,
    ...
    public ModularPanel buildUI(PosGuiData guiData, PanelSyncManager guiSyncManager, UISettings settings) {
        ...
        IntSyncValue ampSync = new IntSyncValue(() -> amps, val -> amps = val);
                ...
                .child(Flow.column()
                        ...
                        .child(Flow.row()
                                ...
                                .child(new ButtonWidget<>()
                                        .size(20)
                                        .onMousePressed(mouse -> {
                                            long amps = ampSync.getIntValue();
                                            ampSync.setIntValue(
                                                    (int) Math.min(amps + GTUtility.getButtonIncrementValue(),
                                                            Integer.MAX_VALUE));
                                            return true;
                                        })
