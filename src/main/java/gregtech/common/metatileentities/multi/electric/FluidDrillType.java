...
/**
 * Enum encapsulating all variant-specific configuration for Fluid Drilling Rigs.
 * Each constant fully describes a fluid drill variant's tier, structure materials,
 * renderers, and operational parameters.
 */
public enum FluidDrillType {
