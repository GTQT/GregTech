...
public enum ForgeOfGodsUpgrade {
    ...
    ForgeOfGodsUpgrade() {
        ...
        this.nameShortKey = "fog.upgrade.tt.short." + ordinal();
        this.bodyKey = "fog.upgrade.text." + ordinal();
        this.loreKey = "fog.upgrade.lore." + ordinal();
    }
    ...
    public UpgradeColor getColor() {
        return color;
    }

    public Milestones getIcon() {
        return icon;
    }
    ...
    public static class Builder {
        ...
        private List<ForgeOfGodsUpgrade> prerequisites;
        private boolean requireAllPrerequisites;

        private int shardCost;

        private UpgradeColor color = UpgradeColor.BLUE;
        private Milestones icon = Milestones.CHARGE;
        private PanelSize panelSize = PanelSize.STANDARD;
        private int treeX;
        private int treeY;
        ...
        public Builder color(UpgradeColor color) {
            this.color = color;
            return this;
        }

        public Builder icon(Milestones icon) {
            this.icon = icon;
            return this;
        }
