...
/**
 * Custom UI factory for the Forge of Gods that delegates entirely to {@link MTEForgeOfGodsGui}. Bypasses the standard
 * multiblock display panel in favor of the godforge's full-screen terminal UI.
 */
