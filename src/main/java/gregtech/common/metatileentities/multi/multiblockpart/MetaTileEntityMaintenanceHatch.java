...
public class MetaTileEntityMaintenanceHatch extends MetaTileEntityMultiblockPart
    ...
    public boolean aprilFools() {
        return GTValues.FOOLS.get() && ConfigHolder.misc.specialEvents;
    }
    ...
    public @NotNull ModularPanel buildUI(PosGuiData guiData, PanelSyncManager panelSyncManager,
        ...
        BooleanSyncValue aprilFoolsSync = new BooleanSyncValue(this::aprilFools);

        boolean aprilFools = aprilFoolsSync.getBoolValue();
