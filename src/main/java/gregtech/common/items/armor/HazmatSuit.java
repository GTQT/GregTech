...
public class HazmatSuit implements ISpecialArmorLogic, IItemDurabilityManager {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
        return SLOT != EntityEquipmentSlot.LEGS ?
                "gregtech:textures/armor/hazmat_1.png" :
                "gregtech:textures/armor/hazmat_2.png";
    }
    ...
    public ArmorProperties getProperties(EntityLivingBase player, @NotNull ItemStack armor, DamageSource source,
        ...
        int priority = 0;
        double absorbRatio = getAbsorption(SLOT);
        int absorbMax = getDurability(armor) > 0 ? Integer.MAX_VALUE : 0;
