...
import static gregtech.common.items.behaviors.TraverseOptions.Lambdas.*;

/**
 * Logic from Susy-Core:
 * <a href=
 * "https://https://github.com/SymmetricDevs/Susy-Core/blob/main/src/main/java/supersymmetry/common/item/behavior/TraverseOptions.java">...</a>
 */
public enum TraverseOptions implements ITraverseOption {
    ...
    UNBLOCKING(FIND_CONNECTED, Lambdas.UNBLOCKER),
    ;
