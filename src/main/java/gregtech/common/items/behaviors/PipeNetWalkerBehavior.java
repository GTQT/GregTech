...
import static gregtech.common.items.behaviors.TraverseOptions.*;
/**
 * Logic from Susy-Core:
 * <a href=
 * "https://https://github.com/SymmetricDevs/Susy-Core/blob/main/src/main/java/supersymmetry/common/item/behavior/PipeNetWalkerBehavior.java">...</a>
 */
public enum PipeNetWalkerBehavior implements IToolBehavior {
    ...
    public void addInformation(@NotNull ItemStack stack, World world, List<String> tooltip,
        ...
        tooltip.add(I18n.format("item.gt.tool.behavior.pipeliner"));

        if (stack.getItem() instanceof IGTTool tool) {
            tooltip.add(I18n.format("item.gt.tool.tooltip.pipeliner",
