 ...
 * <a href=
 * "https://https://github.com/SymmetricDevs/Susy-Core/blob/main/src/main/java/supersymmetry/common/item/behavior/PipeOperationWalker.java">...</a>
 */
public class PipeOperationWalker<T extends IPipeTile<?, ?>> {
    ...
    private void traverse(int maxWalks) {
        ...
        if (walkedBlocks >= maxWalks) {
            GTLog.logger.fatal("The walker reached the maximum amount of walks {}", walkedBlocks);
        }
        invalid = true;
    }
