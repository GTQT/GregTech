...
public class MetaTileEntityMEOrePrefixPatternProviderProxy extends MetaTileEntityMultiblockNotifiablePart
        implements IMultiblockAbilityPart<DualHandler>,
                   IDataStickIntractable {

    private MetaTileEntityMEOrePrefixPatternProvider main;
    private BlockPos mainPos;
    private boolean checkForMain = true;

    public MetaTileEntityMEOrePrefixPatternProviderProxy(ResourceLocation metaTileEntityId) {
    ...
    private void tryToSetMain() {
        ...
        if (!(metaTileEntity instanceof MetaTileEntityMEOrePrefixPatternProvider budgetCRIB)) {
            this.checkForMain = true;
            return;
        }
    ...
    private MetaTileEntityMEOrePrefixPatternProvider getMain() {
        return main;
    }
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityMEOrePrefixPatternProviderProxy(metaTileEntityId);
    }
