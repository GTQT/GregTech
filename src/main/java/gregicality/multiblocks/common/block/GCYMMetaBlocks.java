...
public final class GCYMMetaBlocks {
    ...
    public static void init() {
        ...
        UNIQUE_CASING.setRegistryName(GregicalityMultiblocks.MODID, "unique_casing");
        LARGE_MULTIBLOCK_CASING = new BlockLargeMultiblockCasing();
        LARGE_MULTIBLOCK_CASING.setRegistryName(GregicalityMultiblocks.MODID, "large_multiblock_casing");
    }
